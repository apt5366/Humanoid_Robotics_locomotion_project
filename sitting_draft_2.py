...
def sitting_down():
    ...
    set_body_pos(BODY_LHIP, 476, 1500)
    set_body_pos(BODY_LTHI, 611, 1500)
    set_body_pos(BODY_LKNE, 305, 1500)
    set_body_pos(BODY_LSHI, 359, 1500)
    set_body_pos(BODY_LANK, 498, 1500)
    set_body_pos(BODY_RHIP, 498, 1500)
    set_body_pos(BODY_RTHI, 405, 1500)
    set_body_pos(BODY_RKNE, 792, 1500)
    set_body_pos(BODY_RSHI, 504, 1500)
    set_body_pos(BODY_RANK, 511, 1500)
    time.sleep(1.5)
    
    set_body_pos(BODY_RSHI, 353, 1500)
    time.sleep(1.5)
    
    set_body_pos(BODY_RTHI, 363, 1500)
    set_body_pos(BODY_RKNE, 624, 1500)
    set_body_pos(BODY_RSHI, 351, 1500)
    time.sleep(1.5)
    
    set_body_pos(BODY_RTHI, 238, 1500)
    time.sleep(1.5)
    
    set_body_pos(BODY_RSHO, 71, 750)
    time.sleep(1.5)
    
    set_body_pos(BODY_LKNE, 259, 1500)
    set_body_pos(BODY_LSHI, 495, 1500)
    time.sleep(1.5)
    
    set_body_pos(BODY_LKNE, 424, 1500)
    set_body_pos(BODY_LSHI, 769, 1500)
    time.sleep(1.5)
    
    set_body_pos(BODY_LSHO, 943, 750)
    time.sleep(1.5)
